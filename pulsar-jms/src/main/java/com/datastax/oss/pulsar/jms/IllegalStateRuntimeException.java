...
public class IllegalStateRuntimeException extends JMSRuntimeException {
    ...
    /**
     * Constructs a {@code IllegalStateRuntimeException} with the specified detail message and error code.
     *
     * @param detailMessage a description of the exception
    ...
    /**
     * Constructs a {@code IllegalStateRuntimeException} with the specified detail message, error code and cause
     *
     * @param detailMessage a description of the exception
     * @param errorCode a provider-specific error code
